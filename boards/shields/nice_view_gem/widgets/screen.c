...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_canvas_set_buffer(middle, widget->cbuf2, SCREEN_HEIGHT, SCREEN_HEIGHT, LV_IMG_CF_TRUE_COLOR);
    ...
    lv_canvas_set_buffer(bottom, widget->cbuf3, SCREEN_HEIGHT, SCREEN_HEIGHT, LV_IMG_CF_TRUE_COLOR);
